describe 'DocumentService', ->
  # NOTE: These tests only work with localstorage which is disabled
  # in Test due to performance reasons. If there is a problem with
  # localstorage you can run these tests in isolation using ldLocalApi.
  #
  # revision0 = {
  #   content: [
  #     {
