...
.directive('pagination', ['paginationConfig', function(config) {
  return {
    ...
    template: '<div class="upfront-pagination"><ul><li ng-repeat="page in pages" ng-class="{active: page.active, disabled: page.disabled}"><a ng-click="selectPage(page.number)">{{page.text}}</a></li></ul></div>',
    replace: true,
